...
<?php
  ...
  //percorrer o resgistro enquanto houver linhas.
  while(!feof($arquivo)){ //percorre as linhas do arquivo.
    //linha
            ...
            <div class="card-body">
              ...
              <?php 
                ...
                if($_SESSION['perfil_id'] == 2){
                  //so sera exibido os chamados criado pelo perfil
                  if($_SESSION['id'] != $chamado_dados[0]) {
                    continue;
                  }
                } 

                //se não tiverem elementos suficientes eles
